package com.weicai.demo.shiro;
import com.weicai.demo.pojo.Permission;
import com.weicai.demo.pojo.Role;
import com.weicai.demo.pojo.User;
import com.weicai.demo.util.StaticStr;
...
public class NutDaoRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        String _captcha = Strings.sBlank(SecurityUtils.getSubject().getSession(true).getAttribute(StaticStr.img_captcha));
